...
async function seed() {
  const taskSeeds = [
    ...
    {
      id: "live_visit_twitch",
      title: "Посетить стрим Twitch",
      description: "Открой активный стрим Twitch и вернись за наградой.",
      reward: 75,
      platform: "twitch",
      type: "daily",
      validationType: "manual",
      meta: {
        liveOnly: true,
        liveAction: "watch_stream",
        periodKeySource: "live_broadcast",
        progressSource: "live_watch_twitch",
        targetValue: 1,
        progressLabel: "Стрим посещён",
        actionLabel: "Открыть Twitch",
        verifyLabel: "Зайти на стрим",
        uiSection: "live_stream_tasks",
        uiOrder: 1,
      },
    },
    {
      id: "live_visit_kick",
      title: "Посетить стрим Kick",
      description: "Открой активный стрим Kick и вернись за наградой.",
      reward: 75,
      platform: "kick",
      type: "daily",
      validationType: "manual",
      meta: {
        ...
        liveAction: "watch_stream",
        periodKeySource: "live_broadcast",
        progressSource: "live_watch_kick",
        targetValue: 1,
        progressLabel: "Стрим посещён",
    ...
    },
    {
      ...
      title: "Сообщение в чате Twitch",
      description:
        "Напиши сообщение в чате активного Twitch-стрима и отправь его текст для проверки.",
      reward: 100,
      platform: "twitch",
      type: "daily",
      validationType: "manual",
      meta: {
        ...
        verifyLabel: "Проверить сообщение",
        uiSection: "live_stream_tasks",
        uiOrder: 2,
      },
    },
    {
      ...
      title: "Сообщение в чате Kick",
      description:
        "Напиши сообщение в чате активного Kick-стрима и отправь его текст для проверки.",
      reward: 100,
      platform: "kick",
      type: "daily",
      validationType: "manual",
